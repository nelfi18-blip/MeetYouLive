  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        /* ── Bottom nav ─────────
           Removed: a dedicated <BottomNav /> component (.bottom-nav-modern)
           rendered by <BottomNavWrapper /> is now the single mobile bottom
           navigation across the app, avoiding a duplicate "Inicio" entry. */
