...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Bottom nav for mobile — only render when the modern <BottomNavWrapper>
          is NOT rendering its own on the current route. This prevents the
          "dos inicios" (duplicate Home buttons) issue on /feed, /matches,
          /chats, /profile, etc. */}
