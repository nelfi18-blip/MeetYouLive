...
describe("photoFields", () => {
  ...
  test("normalizes legacy avatar into canonical images[0]", () => {
    ...
    expect(state.avatar).toBe("https://meetyoulive.onrender.com/uploads/avatar.webp");
  ...
  test("syncPhotoAliases is an alias for canonical image/avatar/profilePhotos sync", () => {
    ...
    expect(syncPhotoAliases(user, req)).toMatchObject({
      avatar: "https://meetyoulive.onrender.com/uploads/avatar.webp",
      profilePhotos: ["https://meetyoulive.onrender.com/uploads/avatar.webp"],
      images: [expect.objectContaining({ url: "https://meetyoulive.onrender.com/uploads/avatar.webp", isPrimary: true })],
    });
  });
  ...
  test("normalizes profilePhotos[0] into canonical images[0]", () => {
    ...
    expect(images[0]).toMatchObject({
      url: "https://meetyoulive.onrender.com/uploads/profile.webp",
      isPrimary: true,
    });
  });
  ...
  test("returns the primary normalized photo URL only from valid photo values", () => {
    ...
    expect(getPrimaryPhotoUrl({ images: [{ url: "" }, { url: "/uploads/second.webp" }] }, req)).toBe(
      "https://meetyoulive.onrender.com/uploads/second.webp"
    );
  ...
  test("keeps canonical profile photos before aliases and removes duplicates", () => {
    ...
    expect(user.avatar).toBe("https://meetyoulive.onrender.com/uploads/avatar-user-1.webp");
    expect(user.profilePhotos).toEqual([
      "https://meetyoulive.onrender.com/uploads/avatar-user-1.webp",
  ...
  test("reports photo count and primary field used for diagnostics", () => {
    ...
    expect(selection).toEqual({
      primaryPhoto: "https://meetyoulive.onrender.com/uploads/avatar.webp",
      photos: [
        "https://meetyoulive.onrender.com/uploads/avatar.webp",
        "https://meetyoulive.onrender.com/uploads/first.webp",
