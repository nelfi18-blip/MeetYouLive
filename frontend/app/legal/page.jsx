  ...
  return (
    <main className="legal-index">
      ...
      <style jsx>{`
        ...
        .legal-card { border: 1px solid var(--border); border-radius: 20px; padding: 1.25rem; background: rgba(255,255,255,0.03); text-decoration: none; display: grid; grid-template-columns: minmax(0, 1fr); align-content: start; row-gap: 0.65rem; min-height: 180px; transition: transform 0.15s, border-color 0.15s; }
        ...
        @media (max-width: 430px) {
          ...
          .legal-card { padding: 1.1rem; row-gap: 0.7rem; min-height: 0; }
        }
      `}</style>
    </main>
  );
