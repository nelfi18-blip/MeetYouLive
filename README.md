...
- Platform: Vercel
- Directory: `frontend`
- URL: `https://meetyoulive.net` (canonical; `www.meetyoulive.net` 308-redirects to the apex)
...
2. Set environment variables:
   ...
   ```
3. In **Project → Settings → Domains** add `meetyoulive.net` as the primary canonical domain and `www.meetyoulive.net` configured to redirect (308) to `meetyoulive.net`.
