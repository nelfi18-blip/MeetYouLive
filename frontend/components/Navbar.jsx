...
export default function Navbar() {
  ...
  const NAV_LINKS = [
    { href: "/dashboard", label: nav.home, icon: "🏠" },
    { href: "/explore", label: nav.explore, icon: "🔍" },
    { href: "/live", label: nav.live, icon: "🎥" },
    { href: "/chats", label: nav.chats, icon: "💬" },
    ...
    <>
      <nav className="navbar">
        ...
        <div className="navbar-right">
          ...
          <div className="navbar-user" onClick={() => setMenuOpen(!menuOpen)}>
            ...
            <span className="navbar-username">{session?.user?.name || username || nav.user}</span>
      ...
      <nav className="bottom-nav">
        ...
        <div className="bottom-lang">
          <button
            className={`lang-btn-sm${lang === "es" ? " active" : ""}`}
            onClick={() => setLang("es")}
          >ES</button>
          <button
      ...
      <style jsx>{`
        ...
        .lang-btn-sm.active { background: var(--accent); border-color: var(--accent); color: #fff; }
